  ...
  return (
    <section className="bg-primary xl:h-[1090px] w-full pt-[149px] pb-20 relative">
      <div className="container mx-auto md:flex-row justify-between lg:py-4 lg:px-6 py-3 px-4">
        <div data-aos="fade-right" className="text-left xl:w-[657px] md:w-full md:pb-[90px] sm:pb-[40px] lg:w-[550px]">
            <div>
                <p className="underline underline-offset-8 text-[24px] leading-[34px] text-white mb-[24px] md:mb-[48px] lg:mb-[64px]">Towing</p>
