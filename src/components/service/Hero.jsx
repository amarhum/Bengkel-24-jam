import heroImg from "../../assets/personBanner2.png";
import bawah from "../../assets/service-bawah.svg";
  ...
  return (
    <section className="bg-primary xl:h-[1090px] w-full pt-[149px] pb-20 relative">
      <div className="container mx-auto md:flex-row justify-between lg:py-4 lg:px-6 py-3 px-4">
        <div data-aos="fade-right" className="text-left xl:w-[657px] lg:w-[550px] pb-[90px] lg:pb-[80px]">
            <div>
                <p className="underline underline-offset-8 text-[24px] leading-[34px] text-white mb-[24px] md:mb-[48px] lg:mb-[64px]">Service</p>
